...
const Header = () => {
  return (
    <header className="text-center py-4">
      <h1 className="text-2xl md:text-4xl font-regular font-serif">Adam`&apos;`s Page</h1>
    </header>
  );
}
  ...
  return (
    <section className="text-xl p-2 mx-auto max-w-4xl text-justify font-serif">
      <div className="space-y-4">
        <h2 className="text-center text-2xl md:text-3xl font-regular mb-4">Hellllo</h2>
        <p>
          I`&apos;`m Adam. 
        </p>
